...
### For End Users
1.  Visit [https://ptero.pro](https://ptero.pro).
...
1.  Download the plugin from the [GitHub repository](https://github.com/aminkheddache-dotcom/Pterocos).
...
Ptero is licensed under the **GPL v2 or later**. This ensures the project remains free and open-source for everyone. For more details, see the [LICENSE](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html) file.
